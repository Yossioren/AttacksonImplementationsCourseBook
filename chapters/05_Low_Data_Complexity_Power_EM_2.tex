\chapter{Low Data Complexity Power/EM 2}\label{chap:c5_PowerEM2}

\href{https://orenlab.sise.bgu.ac.il/AttacksonImplementationsCourseBook/#lecture-5---power-em-side-channels-ii}{View the video recordings for this chapter}
...
\textbf{Amplified Template Attack}
    ...
    \section{Related work} \label{sec:LowDataComplexityRelatedWork}
    \begin{itemize}
